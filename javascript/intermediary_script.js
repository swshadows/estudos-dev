...
document.body.innerHTML = "<h1>Titulo inserido com JS</h1>" + document.body.innerHTML;
...
console.log("textContent mostra até o conteudo oculto, enquanto o innerText não: " + p.textContent);
